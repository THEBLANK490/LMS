...
//       for (const value of _formData.values()) {
//         console.log(value);
//         //This logs value 1 and 2 meaning the values are appended sucessfully
//       }
//       try {
//         const response = await axios.post(baseUrl + "/student-enroll-course/", _formData, {
//           headers: {
...
//         //   setEnrollStatus('alreadyEnrolled');
//         //   Swal.fire({
...
//             <p className="font-bold mb-8">Students Enrolled: {courseData.total_enrolled_student} Students </p>
//             {
//               enrollStatus === 'success' && userLoginStatus === 'success' &&
//               <p><span className="bg-gray-700 text-white font-bold py-2 px-4 rounded">You are already enrolled in this course.</span></p>
//             }
//             {
...
const CourseDetail = () => {
  ...
  let { course_id } = useParams();
    ...
    // const categoryInstance = courseData.find((category) => category.id === course_id);
    ...
    const enrollCourse = async() => {
      ...
      // formData.append('course',parseInt(course_id));
      formData.append('course',parseInt(courseData.id));
      // formData.append('course',categoryInstance);
